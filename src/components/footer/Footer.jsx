...
export default function Footer() {
  return (
    <footer className="w-full mt-32">
      <div className="mx-auto px-4 flex max-w-6xl flex-col items-start space-x-8 md:flex-row">
      ...
      <div className="mx-auto max-w-6xl items-center justify-between px-4 md:flex lg:px-0">
        <div className="inline-flex items-center">
          ...
          <span className="ml-4 text-lg font-bold">Sifting Bytes</span>
        </div>
        <div className="mt-4 md:mt-0">
          <p className="text-sm font-medium text-gray-500">© 2023 Sifting Bytes Technologies. All rights reserved.</p>
        </div>
      </div>
    </footer>
  )
